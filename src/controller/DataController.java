...
public class DataController {
    ...
    static List<PresensiStaff> ps(Status s1, Status s2, Status s3){
        ...
        PresensiStaff p1 = new PresensiStaff("17 April 2018", s1, 6);
        PresensiStaff p2 = new PresensiStaff("18 April 2018", s2, 6);
        PresensiStaff p3 = new PresensiStaff("19 April 2018", s3, 6);
